...
# Get courses along with subjects.
class CourseListView(TemplateResponseMixin, View):
    model = Course
    template_name = 'courses/course/list.html'

    def get(self, request, subject=None):
        # retrieve all subjects and courses.
        subjects = Subject.objects.annotate(total_courses =Count('courses'))
        courses = Course.objects.annotate(total_modules=Count('modules'))

        if subject:
            # A subject's slug URL is given - retrieve corresponding subject object.
...
# Display single course overview
class CourseDetailView(DetailView):
    model = Course
    template_name = 'courses/course/detail.html'

    # Include enrollment form in the context for rendering the template.
